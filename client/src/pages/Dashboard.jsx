        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2">
              <button className="px-3 py-1 bg-cyan-50 text-cyan-700 rounded-lg text-xs font-medium hover:bg-cyan-100">
                #marketing
              </button>
              <button className="px-3 py-1 bg-purple-50 text-purple-700 rounded-lg text-xs font-medium hover:bg-purple-100">
                #socialmedia
              </button>
              <button className="px-3 py-1 bg-pink-50 text-pink-700 rounded-lg text-xs font-medium hover:bg-pink-100">
                #branding
              </button>
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-4">
            <button className="flex-1 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2">
              <RefreshCw className="w-5 h-5" /> Regenerate with AI
            </button>
            <button className="flex-1 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl font-semibold transition-colors flex items-center justify-center gap-2">
      ...
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="aspect-video bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-white font-bold text-lg">
              Your Ad Here
            </div>
          </div>
          <div>
            ...
            <div className="aspect-[9/16] max-w-[250px] mx-auto bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center text-white font-bold">
              Mobile View
            </div>
          </div>
        </div>
